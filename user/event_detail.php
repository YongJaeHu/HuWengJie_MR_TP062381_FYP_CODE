         ...
         while($fetch_event = $event->fetch(PDO::FETCH_ASSOC)){
            ...
            <form class="box" method="post">
               ...
               <a href="../user/centre_detail.php?admin_id=<?= $fetch_admin['id']; ?>">
                  ...
                  <div><a href="../user/centre_detail.php?admin_id=<?= $fetch_event['admin_id']; ?>"><?= $fetch_admin['name']; ?></a><div>
            ...
            <div class="icons">
               ...
               <a href="event_view.php" class="inline-exit-btn">go back</a>
            </form>
            <?php
         }
      }else{
      ...
      <div class="box">
         <div class="user">
            <?php if ($fetch_commentor && $fetch_commentor !== false) { ?>
               ...
               <div>
                  <h3>
                  <a href="../user/user_detail.php?uder_id=<?= $fetch_commentor['id']; ?>"><?= $fetch_commentor['name']; ?></a></h3>
