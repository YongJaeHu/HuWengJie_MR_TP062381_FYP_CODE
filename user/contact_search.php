...
<?php
   ...
   <div class="box_container">
      ...
      <?php
      if(isset($_POST['search_contact']) or isset($_POST['search_contact_btn'])){
               $search_contact = $_POST['search_contact'];
               $search_contact = "%{$search_contact}%";
               $report = $conn->prepare("SELECT * FROM `contact` WHERE title LIKE ? and receiver_id = ?");
               $report->execute([$search_contact, $id]);
