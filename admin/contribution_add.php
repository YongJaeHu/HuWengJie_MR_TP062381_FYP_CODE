...
if(isset($_POST['publish'])){
   ...
   $insert_post = $conn->prepare("INSERT INTO `contribute`(id, sender_id, centre_id, title, description, image) VALUES(?,?,?,?,?,?)");
   $insert_post->execute([$contribute_id, $sender_id, $receiver_id, $title, $content, $re_image]);
   move_uploaded_file($image_tmp_name, $image_folder);
   $success_msg[] = 'Sent!';
...
<section class="ar_edit">
   ...
   <h1 class="heading">Contribution form</h1>
      ...
      <p><i>Centre Email: </i><?= $fetch_admin['email']; ?></p>
      <p>Title <span>*</span></p>
      ...
      <a href="../admin/admin_detail.php?admin_id=<?= $fetch_admin['id']; ?>" class="exit-btn">Back</a>
   </form>
