...
<section class="com_edit">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         <a href="article_detail.php?kid_id=<?= $kid_id; ?>" class="inline-exit-btn" onclick="confirm_msg(event);">cancel edit</a>
   ...
   <div class="box_container">
         ...
         while($fetch_kid = $select_kid->fetch(PDO::FETCH_ASSOC)){
            ...
            <form class="box" method="post">
               ...
               <a href="../admin/admin_detail.php?admin_id=<?= $fetch_admin['id']; ?>">
                  ...
                  <div><a href="../admin/admin_detail.php?admin_id=<?= $fetch_kid['centre_id']; ?>"><?= $fetch_admin['name']; ?></a><div>
                     <?= $fetch_kid['date']; ?></div>
                  </div>
               </div>
      ...
      <div class="box">
         ...
         <p class="content"><?= $fetch_kid['description']; ?></p>
            ...
            <!-- <div class="title"><?= $fetch_kid['title']; ?></div>
            <div class="content"><?= $fetch_kid['content']; ?></div> -->
            <!-- <div class="icons">
      ...
      <div class="box">
         <div class="user">
            <?php if ($fetch_commentor && $fetch_commentor !== false) { ?>
               <a href="user_detail.php?user_id=<?= $fetch_commentor['id']; ?>">
               <img src="../images/<?= $fetch_commentor['image']; ?>" alt=""></a>
               <div>
                  <h3>
                  <a href="user_detail.php?user_id=<?= $fetch_commentor['id']; ?>"><?= $fetch_commentor['name']; ?></a></h3>
