...
// $email = $_GET['email']; // Retrieve the email from the URL parameter
if (!isset($id)) {
   ...
   <div class="status" style="background-color:<?php
    ...
    <div class="swiper-pagination"></div>
     ...
     <div class="info"> 
      ...
      <?php } ?>
         <a href="admin_page.php" class="exit-btn">go back</a>
      </div>
   </form>
   <?php
         }
   ...
   ?>
         ...
         <div class="box">
            <div class="user">
               ...
               <div>
                  <h3>
                  <a href="user_detail.php?user_id=<?= $fetch_user['id']; ?>"><?= $fetch_user['name']; ?></a></h3>
