...
if (isset($_POST['reset_password'])) {
   ...
   if ($admin->rowCount() > 0) {
      ...
      $mail->Body = "Dear user,<br><br>Please click the following link to reset your password:<br>http://localhost/HuWengJie_MR_TP062381_FYP_CODE/admin/admin_newpass.php?email=" . urlencode($email) . "&token=" . urlencode($token) . "<br><br>If you didn't request a password reset, please ignore this email.<br><br>Best regards,<br>The Support Team";
