...
if(isset($_POST['delete'])){
   ...
   // exit();
      ...
      $error_msg[] = 'Failed to delete the article.';
   }
}
         ...
         while($fetch_post = $article->fetch(PDO::FETCH_ASSOC)){
            ...
            <form class="box" method="post">
               ...
               <a href="../admin/admin_detail.php?admin_id=<?= $fetch_admin['id']; ?>">
                  ...
                  <div><a href="../admin/admin_detail.php?admin_id=<?= $fetch_post['admin_id']; ?>"><?= $fetch_admin['name']; ?></a><div>
                     <?= $fetch_post['date']; ?></div>
                  </div>
               </div>
            ...
            <div class="icons">
               ...
               <a href="article_view.php" class="exit-btn">go back</a>
            </form>
            <?php
         }
      }else{
